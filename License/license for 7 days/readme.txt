1、授权文件解压缩后将.user文件拷贝到项目的Data文件夹下，重启项目即可
2、非商用永久免费，为确保我们大家拿到最新版本，非商用授权为7天；授权到期后，可以访问网站获得最新授权与最新的程序包；如果需要长期授权，请联系商用授权。
3、授权文件的大小是 3,356 bytes，大小不符合的都是授权文件破坏了，需要提醒管理员重新上传。
